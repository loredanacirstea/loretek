      ...
      <div class="row clearfix">
        <div class="col-md-12 column">
          ...
          <div class="contact_group">
            <img class="avatar" alt="" src="images/avatar_svg.png" />
            <div class="contact_details">
              <h4>Contact: loredana.cirstea at gmail</h4>
              <div class="social_media">
                <a href="http://ro.linkedin.com/pub/loredana-cirstea/96/a77/aa3/" target="_blank"><img class="linked" alt="" src="images/linked.png" /></a>
                <a href="http://github.com/loredanacirstea/" target="_blank"><img class="linked" alt="" src="images/github.png" /></a>
              </div>
            </div> 
          </div>
        </div>
